...
True          SumPrint        - Print summary data to "<RootName>.sum" (flag)
    0.00125   SttsTime        - Amount of time between screen status messages (s)
    0.00125   ChkptTime       - Amount of time between creating checkpoint files for potential restart (s)
